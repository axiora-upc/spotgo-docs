...
Para el desarrollo del tercer sprint nos centramos en la elaboración del backend de nuestra aplicación, para ello lo dividimos de acuerdo a la cantidad de bounded context con cada integrante del grupo (fueron 5 bounded context, 1 por cada integrante). El back será elaborado teniendo en cuenta el flujo de datos del Diagrama de Base de datos.
...
| **Sprint 3 Goal** | El objetivo de este tercer sprint es elaborar el backend de nuestro aplicativo. Se han implementado las APIs RESTful para nuestro aplicativo y se ha realizado la documentación de los endpoints en Swagger. |
...
| US21 | Product Promotional Video | TS21.2 | Embed Promotional Video | Integrar video promocional de YouTube con fallback a imagen estática. | 2 | @nes-ro | Done |
